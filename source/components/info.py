...
class Info:
    def __init__(self,state):
        ...
        self.flash_coin=coin.FlashiingCoin()
    ...
    def create_info_labels(self):
        ...
        self.info_labels.append((self.create_label('000000'), (75, 60)))
        self.info_labels.append((self.create_label('x00'), (300, 60)))
        self.info_labels.append((self.create_label('1-1'), (480, 60)))
